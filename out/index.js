...
var tagTypeRoutes_1 = require("./Routes/tagTypeRoutes");
...
var userService_1 = require("./domain/Service/userService");
var userRepositoryImp_1 = require("./infra/repository/userRepositoryImp");
...
routes.push(new userRoutes_1.UserRoutes(app, new userService_1.UserService(new userRepositoryImp_1.UserRepositoryImp())));
